...
from .aggressive import minify_dom_text, prepare_messages_for_aggressive_mode
...
def chat_completions() -> Response:
    ...
    if bool(current_app.config.get("AGGRESSIVE_MODE")):
        messages = prepare_messages_for_aggressive_mode(messages)
...
def completions() -> Response:
    ...
    if bool(current_app.config.get("AGGRESSIVE_MODE")) and isinstance(prompt, str) and len(prompt) > 1000:
        prompt = minify_dom_text(prompt)
